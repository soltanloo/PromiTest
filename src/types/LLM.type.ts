...
export namespace LLM {
    ...
    export const GPTModels = new Set<Model>([
        Model.GPT4OMINI,
        Model.GPT4O,
        Model.GPT4TURBO,
        Model.GPT4,
    ...
    export const HFModels = new Set<Model>([
        //HFModel.LLAMA_3_1_70B,
        //HFModel.LLAMA_3_1_8B,
        Model.PHI_3_MINI_4k,
        Model.MISTRAL_7B,
        Model.MISTRAL_8X7B,
        //HFModel.QWEN2_0_5B,
        //HFModel.YI_CODER_9B,
        //HFModel.C4AI_COMMAND_R,
        //HFModel.HERMES_3_LLAMA_3_1_8B,
        //HFModel.QWEN2_72B,
        // HFModel.STARCODER,
        //HFModel.GRABBE, // doesnt work
    ]);

    export const chatCompletionModels = new Set<Model>([
        //HFModel.LLAMA_3_1_70B, // premium
        //HFModel.LLAMA_3_1_8B, // premium
        Model.PHI_3_MINI_4k, //works
        Model.MISTRAL_7B, //works
        Model.MISTRAL_8X7B, //works
    ...
    export const apiPlaintextModels = new Set<Model>([
        // HFModel.STARCODER,
        //HFModel.GRABBE, // doesnt work
    ]);
