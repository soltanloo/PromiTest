...
export class ReportGenerator {
    ...
    public addData(
        ...
        // Add the flag report to the promise
        ...
        this._report
            ...
            ?.promises.forEach((llmReport) => {
                llmReport.promises.forEach((promiseReport) => {
                    ...
                    promiseReport.code = promiseNode.promiseInfo.code;
                });
            });
    }
    public generateReport() {
        ...
        promiseSummaryData.push(
            'Project Name,Location,Flag,Percentage (%),Code',
        );
                ...
                llmReport.promises.forEach((promise) => {
                    ...
                    promise.flags.forEach((flag) => {
                        ...
                        promiseLocationTotals[uniqueLocationWithFlag].total +=
                            1;
                        promiseLocationTotals[uniqueLocationWithFlag].code =
                            code;
                    });
        ...
        for (const [
            ...
            promiseSummaryData.push(
                `${projectName},${location},${flag},${successRate.toFixed(2)},${code}`,
            );
        }
